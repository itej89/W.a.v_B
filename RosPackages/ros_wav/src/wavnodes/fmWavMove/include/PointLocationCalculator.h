...
namespace fmWavMove
{
    ...
    {
        public:
            bool IsPointInPolygon(geometry_msgs::Point p, geometry_msgs::Point polygon[])
            {
            ...
            bool IsInsideTransformedPolygon(geometry_msgs::Point Polygon[], geometry_msgs::Pose PolygonPose, , geometry_msgs::Pose Point)
            {
