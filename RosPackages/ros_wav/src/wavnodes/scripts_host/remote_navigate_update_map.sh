...
ssh wav@10.42.0.1 'bash /home/wav/Documents/fmSpin/WavRos/wav_ros_packages/ros_wav/src/wavnodes/scripts_bot/runbot_navigate_update_map.sh' &
...
botKillID=$(ssh wav@10.42.0.1   ps aux | grep -e "[r]unbot_navigate_update_map.sh" | awk -F" " '{print $2}')
