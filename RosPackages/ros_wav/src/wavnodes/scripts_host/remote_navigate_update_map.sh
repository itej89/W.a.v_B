...
ssh wavb@10.42.0.1 'bash /home/tej/Documents/fmSpin/W.a.v_B/RosPackages/ros_wav/src/wavnodes/scripts_bot/runbot_navigate_update_map.sh' &
...
botKillID=$(ssh wavb@10.42.0.1   ps aux | grep -e "[r]unbot_navigate_update_map.sh" | awk -F" " '{print $2}')
