...
ssh tej@10.42.0.1 'bash /home/tej/Documents/WavRos/ros_wav/src/wavnodes/scripts/localize.sh' &
...
botKillID=$(ssh tej@10.42.0.1   ps aux | grep -e "[l]ocalize.sh" | awk -F" " '{print $2}')
