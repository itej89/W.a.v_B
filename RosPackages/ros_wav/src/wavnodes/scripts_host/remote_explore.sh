...
ssh wav@10.42.0.1 'bash /home/wav/Documents/fmSpin/WavRos/wav_ros_packages/ros_wav/src/wavnodes/scripts_bot/runbot_explore.sh' &
...
ssh wav@10.42.0.1 'bash /home/wav/Documents/fmSpin/WavRos/wav_ros_packages/ros_wav/src/wavnodes/scripts_bot/save_map.sh'


botKillID=$(ssh wav@10.42.0.1   ps aux | grep -e "[r]unbot_explore.sh" | awk -F" " '{print $2}')
