...
{
     class KineticsRequestDelay : public KineticsRequestForActuator {
    public:
        int Delay;

        KineticsRequestDelay(int delay, Actuator::etype actuatorType);

        KineticsRequestDelay(string command);
