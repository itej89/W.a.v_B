...
{
     class KineticsRequestEEPROMWrite : public KineticsRequest {
    public:
        EEPROMDetails *MemoryLocation;
        int Value;

        KineticsRequestEEPROMWrite(EEPROMDetails memoryLocation, int value);

        KineticsRequestEEPROMWrite(string command);
