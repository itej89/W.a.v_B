...
{
     class KineticsRequestServoEasing : public KineticsRequestForActuator {
    public:
        CommandLabels::EasingFunction::etype EasingFunction;

        KineticsRequestServoEasing(CommandLabels::EasingFunction::etype easing, Actuator::etype actuatorType);

        KineticsRequestServoEasing(string command);
