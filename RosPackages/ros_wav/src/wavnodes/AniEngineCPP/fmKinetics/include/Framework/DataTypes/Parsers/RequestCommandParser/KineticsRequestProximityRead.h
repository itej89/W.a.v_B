...
{
     class KineticsRequestProximityRead : public KineticsRequest {
    public:
        Actuator::etype ActuatorType;

        KineticsRequestProximityRead(Actuator::etype actuatorType);

        KineticsRequestProximityRead(string command);
