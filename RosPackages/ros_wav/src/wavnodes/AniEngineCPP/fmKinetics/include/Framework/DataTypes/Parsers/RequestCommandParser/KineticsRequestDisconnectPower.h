...
{
     class KineticsRequestDisconnectPower : public KineticsRequestForActuator {
    public:

        KineticsRequestDisconnectPower( Actuator::etype actuatorType);

        KineticsRequestDisconnectPower(string command);
