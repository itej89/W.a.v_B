...
namespace fmKinetics
{
 ...
 class KineticsRequestDettachLockServo : public KineticsRequestForActuator
{
   public:
    Actuator::etype ActuatorType;
    

     KineticsRequestDettachLockServo(Actuator::etype actuatorType);
    
     KineticsRequestDettachLockServo(string command);
};
