...
{
     class KineticsRequestConnectPower : public KineticsRequestForActuator {
    public:

        KineticsRequestConnectPower( Actuator::etype actuatorType);

        KineticsRequestConnectPower(string command);
