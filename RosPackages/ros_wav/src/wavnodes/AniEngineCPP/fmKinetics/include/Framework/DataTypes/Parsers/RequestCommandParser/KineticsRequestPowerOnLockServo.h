...
{
     class KineticsRequestPowerOnLockServo : public KineticsRequestForActuator {
    public:

        KineticsRequestPowerOnLockServo( Actuator::etype actuatorType);

        KineticsRequestPowerOnLockServo(string command);
