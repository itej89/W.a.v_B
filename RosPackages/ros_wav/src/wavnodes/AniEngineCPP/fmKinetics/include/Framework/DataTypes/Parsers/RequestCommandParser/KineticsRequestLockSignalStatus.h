...
namespace fmKinetics
{
 ...
 class KineticsRequestLockSignalStatus : public KineticsRequestForActuator
{
   public:
    

     KineticsRequestLockSignalStatus(Actuator::etype actuatorType);
    
     KineticsRequestLockSignalStatus(string command);
};
