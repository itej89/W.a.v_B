...
{
     class KineticsRequestRightLockServoAngle : public KineticsRequestForActuator {
    public:
        int Angle;
        int PWM_VALUE;

        KineticsRequestRightLockServoAngle(int angle, Actuator::etype actuatorType);

        KineticsRequestRightLockServoAngle(string command);
