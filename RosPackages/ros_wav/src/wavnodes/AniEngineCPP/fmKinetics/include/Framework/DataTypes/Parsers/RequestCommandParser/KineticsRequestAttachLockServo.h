...
namespace fmKinetics
{
 ...
 class KineticsRequestAttachLockServo : public KineticsRequestForActuator
{
   public:
    Actuator::etype ActuatorType;
    

     KineticsRequestAttachLockServo(Actuator::etype actuatorType);
    
     KineticsRequestAttachLockServo(string command);
};
