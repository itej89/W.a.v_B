...
{
     class KineticsRequestDamp : public KineticsRequestForActuator {
    public:
        int Damping;

        KineticsRequestDamp(int damping, Actuator::etype actuatorType);

        KineticsRequestDamp(string command);
