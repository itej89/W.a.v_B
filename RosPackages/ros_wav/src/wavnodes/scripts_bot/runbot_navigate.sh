...
rm ~/Documents/fmSpin/W.a.v_B/RosPackages/ros_wav/src/wavnodes/Maps/rtab_map/TejRoom.db
...
roslaunch wavnodes wav_navigation.launch &
roslaunch wavnodes move_base_Trajectory_Planner.launch &
roslaunch wavnodes WavGoalManager.launch &
wait